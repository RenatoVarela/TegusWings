      ...
      >
        ...
        <div className={classes.paper}>
          ...
          <Typography component="h1" variant="subtitle2">
            ¿Perdiste tu contraseña? Ingrese su dirección de correo electrónico.
            Recibirá un enlace para crear una nueva contraseña por correo
            electrónico.
          </Typography>
          <form className={classes.form} noValidate>
            ...
            >
              ...
              <DialogContent>
                <DialogContentText id="alert-dialog-description">
                  Su correo para la recuperación de contraseña fue enviado
                  correctamente
                </DialogContentText>
              </DialogContent>
              <DialogActions>
            ...
            >
              <DialogTitle id="alert-dialog-title">
                {"Reestablecimiento de contraseña incorrecto"}
              </DialogTitle>
              <DialogContent>
                <DialogContentText id="alert-dialog-description">
                  El correo ingresado para la recuperación de contraseña no esta
                  registrado
                </DialogContentText>
              </DialogContent>
              <DialogActions>
